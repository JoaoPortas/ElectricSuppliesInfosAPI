...
class EfapelScraper:
    """
        Allows to scrap information about the products for the Efapel brand.
    """
    ...
    def scrape_product_info(self, product_id, reset_data_source):
        ...
        filename = "downloads/efapel/caiado_efapel.xlsx"

        if reset_data_source or not os.path.exists(filename):
            self.driver.get("https://www.caiado.pt/efapel")
