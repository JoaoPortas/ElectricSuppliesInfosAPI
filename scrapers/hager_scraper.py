...
class HagerScraper:
    """
        Allows to scrap information about the products for the Hager brand.
    """
    ...
    def scrape_product_info(self, product_id, reset_data_source):
        """
        Scraps Hager product information from caiado website.
        ...
        filename = "downloads/hager/caiado_hager.xlsx"

        if reset_data_source or not os.path.exists(filename):
            self.driver.get("https://www.caiado.pt/hager")
