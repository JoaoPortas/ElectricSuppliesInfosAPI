...
class OBOBettermannScraper:
    """
        Allows to scrap information about the products for the OBO Bettermann brand.
    """
    ...
    def scrape_product_info(self, product_id, reset_data_source):
        """
        Scraps OBO Bettermann product information from caiado website.
        ...
        filename = "downloads/obo-bettermann/caiado_obo_bettermann.xlsx"

        if reset_data_source or not os.path.exists(filename):
            self.driver.get("https://www.caiado.pt/obo-betterman")
