...
class TelevesScraper:
    """
        Allows to scrap information about the products for the Televes brand.
    """
    ...
    def scrape_product_info(self, product_id, reset_data_source):
        """
        Scraps JSL product information from caiado website.
        ...
        filename = "downloads/televes/caiado_televes.xlsx"

        if reset_data_source or not os.path.exists(filename):
            self.driver.get("https://www.caiado.pt/televes")
