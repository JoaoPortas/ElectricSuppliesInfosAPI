...
class TEV2Scraper:
    """
        Allows to scrap information about the products for the TEV2 brand.
    """
    ...
    def scrape_product_info(self, product_id, reset_data_source):
        """
        Scraps TEV2 product information from caiado website.
        ...
        filename = "downloads/tev2/caiado_tev2.xlsx"

        if reset_data_source or not os.path.exists(filename):
            self.driver.get("https://www.caiado.pt/tev2")
